...
trait Relations {
  ...
  @deprecated("Record all products using `addProducts`.", "0.13.7")
   ...
   */
  @deprecated("Record all external dependencies using `addExternalDeps`.", "0.13.7")
  ...
  @deprecated("Record all binary dependencies using `addBinaryDeps`.", "0.13.7")
   ...
   */
  @deprecated("Record all internal dependencies using `addInternalSrcDeps(File, Iterable[InternalDependencies])`.", "0.13.7")
...
object Relations {
  ...
  final class Source private[sbt] (val internal: Relation[File, File], val external: Relation[File, String]) {
    ...
    @deprecated("Use addExternal(File, Iterable[String])", "0.13.7")
