...
import sbt.internal.inc.{ IncrementalCompilerImpl, Analysis, ClasspathOptions, MixedAnalyzingCompiler, ScalaInstance }
import std.TaskExtra._
import xsbti.compile.{ CompileAnalysis, Setup, PreviousResult, CompileResult, Inputs, IncOptions, CompileOrder, GlobalsCache }
...
object Keys {
  ...
  val compilers = TaskKey[IncrementalCompilerImpl.Compilers]("compilers", "Defines the Scala and Java compilers to use for compilation.", DTask)
